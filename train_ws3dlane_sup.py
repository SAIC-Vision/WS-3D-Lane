...
from model.Loss_crit_sup import Laneline_loss_gflat_3D
...
class Trainer(object):
    ...
    def set_criterion(self):
        self.lane_criterion = Laneline_loss_gflat_3D(self.config,
                                                ...
                                                self.train_dataset._y_off_std).to(self.device)
    ...
    def evaluation(self):
        ...
        lane_pred_file = '3dlanenet_sup_pred.json'
        with torch.no_grad():
            self.network.eval()
            val_loss1 = 0.0
            val_loss2 = 0.0
    ...
    def train(self):
        ...
        for self.epoch_idx in range(self.epochs):
            ...
            for batch_idx, batch in enumerate(self.train_loader):
                ...
                batch_loss = batch_loss1 + batch_loss3
                reduced_loss1 = reduce_tensor(batch_loss1.data)
